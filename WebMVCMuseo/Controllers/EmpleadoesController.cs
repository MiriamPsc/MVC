...
namespace WebMVCMuseo.Controllers
{
    public class EmpleadoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idEmpleado,numero,nombre,apellidoPaterno,apellidoMaterno,genero,ciudad,pais,fechaNacimiento,rfc,idTipoEmpleado,estatus,idUsuarioCrea,fechaCrea,idUsuarioModifica,fechaModifica")] Empleado empleado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idEmpleado,numero,nombre,apellidoPaterno,apellidoMaterno,genero,ciudad,pais,fechaNacimiento,rfc,idTipoEmpleado,estatus,idUsuarioCrea,fechaCrea,idUsuarioModifica,fechaModifica")] Empleado empleado)
        {
            if (ModelState.IsValid)
            {
