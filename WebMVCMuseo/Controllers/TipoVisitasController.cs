...
namespace WebMVCMuseo.Controllers
{
    public class TipoVisitasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idTipoVisita,nombre,descripcion,estatus,idUsuarioCrea,fechaCrea,idUsuarioModifica,fechaModifica")] TipoVisita tipoVisita)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idTipoVisita,nombre,descripcion,estatus,idUsuarioCrea,fechaCrea,idUsuarioModifica,fechaModifica")] TipoVisita tipoVisita)
        {
            if (ModelState.IsValid)
            {
