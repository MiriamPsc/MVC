...
namespace WebMVCMuseo.Controllers
{
    public class VisitantesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idVisitante,nombre,apellidoPaterno,apellidoMaterno,correo,telefono,fechaNacimiento,estatus,idUsuarioCrea,fechaCrea,idUsuarioModifica,fechaModifica")] Visitante visitante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idVisitante,nombre,apellidoPaterno,apellidoMaterno,correo,telefono,fechaNacimiento,estatus,idUsuarioCrea,fechaCrea,idUsuarioModifica,fechaModifica")] Visitante visitante)
        {
            if (ModelState.IsValid)
            {
